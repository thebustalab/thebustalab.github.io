...
function check_answer2()
{
    ...
    for(var i = 0; i < radioButtons2.length; i++)
    {
        ...
        {
            var feedback2 = "<p style='color:red'>Wrong; The simpler a model is, the more poorly it will represent the data. The most complex model possible exactly reproduces the observed data, and has 0 degrees of freedom. Topic: fit vs complexity, see lecture.</p>";
...
function check_answer3()
{
    ...
    for(var i = 0; i < radioButtons3.length; i++)
    {
        ...
        {
            var feedback3 = "<p style='color:red'>Wrong; More degrees of freedom means fewer parameters are estimated, so the model is simpler. Topic: fit vs complexity, see lecture.</p>";
...
function check_answer8()
{
    ...
    for(var i = 0; i < radioButtons8.length; i++)
    {
        ...
        {
            var feedback8 = "<p style='color:red'>Wrong; ANCOVA can be represented as multiple regression with dummies for all response categories, and one continuous predictor. Topic: background knowledge.</p>";
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-21-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-23-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-25-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-26-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-27-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-28-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-29-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-36-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-53-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-55-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-56-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-57-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-58-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-59-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-60-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-61-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-62-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-63-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-64-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-65-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-66-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-67-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-70-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-71-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-77-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-79-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-80-1} \end{center}
...
<iframe src="https://dthdpu.shinyapps.io/IntroChromatography/?showcase=0" width="1\linewidth" height="400px" data-external="1"></iframe>
<!-- end -->
...
## #   C <dbl>, N <dbl>, P <dbl>, Cl <dbl>, S <dbl>, F <dbl>,
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-94-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-122-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-129-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-132-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-145-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-152-1} \end{center}
...
\begin{center}\includegraphics[width=1\linewidth]{index_files/figure-latex/unnamed-chunk-161-1} \end{center}
