...
For this set of exercises, please run and visualize a hierarchical cluster analysis on each of the main datasets that we have worked with so far, except for NY_trees. This means [The algae data]("https://thebustalab.github.io/R_For_Chemists/sample_data/algae_data.csv"), [The Alaska lakes data]("https://thebustalab.github.io/R_For_Chemists/sample_data/alaska_lake_data.csv"), [The solvents data]("https://thebustalab.github.io/R_For_Chemists/sample_data/solvents.csv"), and [THIS SUBSET of the periodic table]("https://thebustalab.github.io/R_For_Chemists/sample_data/per_table_small.csv").

For this assignment, you may find the `colnames()` function useful. It will list all the column names in a dataset for you. For example:
...
Put the figure from each cluster analysis in it's own slide of a powerpoint presentation, put your code in the notes section, and send it to me. Let me know if you have any questions!
