...
[the solvents data](https://thebustalab.github.io/R_For_Chemists/sample_data/solvents.csv)
[solvents dataset](https://thebustalab.github.io/R_For_Chemists/sample_data/solvents.csv)
, and [THIS SUBSET of the periodic table](https://thebustalab.github.io/R_For_Chemists/sample_data/per_table_small.csv). You do not need to use the entire periodic table dataset. ..
