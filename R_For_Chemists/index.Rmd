...
Once you have activated `runMatrixAnalysis` in your R session (see below), you can use the function by filling out and executing the basic template below. There is also an advanced template further down the page.
...
Once you do this you will also gain access to the following automatically. This means you can use the following objects in your R Scripts without using readCSV - they are already loaded.
