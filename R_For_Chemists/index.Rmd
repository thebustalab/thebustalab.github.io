...
If you are on Mac, you need to now open your terminal and run the following two commands: `sudo chown -R `whoami`:admin /usr/local/bin` and then `~/Library/TinyTeX/bin/*/tlmgr path add`. 
...
Other options are: if you have Windows, download and install [MikTeX](https://miktex.org/download). If you have OSX, you can download and install MacTeX.
