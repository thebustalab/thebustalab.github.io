...
per_small_pca_ord <- runMatrixAnalysis(
    data = per_small,
    analysis = c("pca-ord"),
...
```{r, echo = FALSE}
data <- read_csv("/Users/lucasbusta/Desktop/9z7ncwvxnz-1/labelled.csv")
...
pca <- runMatrixAnalysis(
  ...
  column_w_names_of_multiple_analytes = NULL,
  column_w_values_for_multiple_analytes = NULL,
  columns_w_values_for_single_analyte = colnames(data)[3:124],
  columns_w_additional_analyte_info = NULL,
  columns_w_sample_ID_info = colnames(data)[1:2]
)

pca$Label <- factor(pca$Label)
