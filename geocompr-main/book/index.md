...
<img src="http://thebustalab.github.io/R_For_Chemists_3/images/R_For_Chemists_logo.jpg" width="100%" style="display: block; margin: auto;" />
...
<img src="http://thebustalab.github.io/R_For_Chemists_3/images/overview.png" width="100%" style="display: block; margin: auto;" />
...
<img src="http://thebustalab.github.io/R_For_Chemists_3/images/rstudio_components.png" width="100%" style="display: block; margin: auto;" />
...
#> 3         1 Tsv1         Heavy             omega_3_polyunsaturated_Fas     186. 
...
<img src="http://thebustalab.github.io/R_For_Chemists_3/images/markdown_1.png" width="100%" style="display: block; margin: auto;" />
...
#> # … with 3 more rows, and 6 more variables: Malania_oleifera <dbl>,
#> #   Ximenia_americana <dbl>, Ongokea_gore <dbl>, Comandra_pallida <dbl>,
#> #   Buckleya_distichophylla <dbl>, Nuytsia_floribunda <dbl>
```
...
<img src="http://thebustalab.github.io/R_For_Chemists_3/images/pipe.jpg" width="100%" style="display: block; margin: auto;" />
...
#> 1        21.1             6 1139 57… Front    Sidewal… Level    Good   PYRUS CA…
#> 2        59.0             6 2220 BE… Across   Sidewal… Level    Good   PLATANUS…
#> 3        92.4            13 2254 BE… Across   Sidewal… Level    Good   PLATANUS…
#> 4        50.2            15 2332 BE… Across   Sidewal… Level    Good   PLATANUS…
#> # … with 378,758 more rows, and 6 more variables: spc_common <chr>,
...
<img src="https://thebustalab.github.io/R_For_Chemists_3/images/chemometrics.jpeg" width="100%" style="display: block; margin: auto;" />
...
<img src="http://thebustalab.github.io/R_For_Chemists_3/images/runMatrixAnalysis1.png" width="100%" style="display: block; margin: auto;" />
...
#> 1 Devil_Mountain_L… Devil_… BELA      33     1          7.25 Devil_… TRUE   204.
#> 2 Imuruk_Lake_BELA  Imuruk… BELA      32     2          4.91 Imuruk… TRUE   204.
#> 3 Kuzitrin_Lake_BE… Kuzitr… BELA      36     3          3.27 Kuzitr… TRUE   204.
#> 4 Lava_Lake_BELA    Lava_L… BELA      35     4          3.02 Lava_L… TRUE   204.
#> # … with 35 more rows, and 16 more variables: y <dbl>, branch <dbl>,
...
<img src="https://thebustalab.github.io/R_For_Chemists_3/images/PCA.png" width="100%" style="display: block; margin: auto;" />
...
#> Warning in FactoMineR::PCA(matrix, graph = FALSE): Missing values are imputed by
...
<img src="http://thebustalab.github.io/R_For_Chemists_3/images/kmeans.png" width="100%" style="display: block; margin: auto;" />
...
#> 1 acetic_acid_C2H4O… acetic… C2H4O2  TRUE             64-19-7    oxygen_… -0.178
#> 2 acetone_C3H6O_TRU… acetone C3H6O   TRUE             67-64-1    oxygen_… -1.66 
#> 3 acetonitrile_C2H3… aceton… C2H3N   TRUE             75-05-8    nitroge… -1.70 
#> 4 benzene_C6H6_FALS… benzene C6H6    FALSE            71-43-2    hydroca…  1.19 
#> # … with 28 more rows, and 8 more variables: Dim.2 <dbl>, kmeans_cluster <chr>,
...
<img src="http://thebustalab.github.io/R_For_Chemists_3/images/Ex6Challenge.png" width="100%" style="display: block; margin: auto;" />
...
#> 1    13.2    12.8 12.8 13.2    0.0312    12.8    13.2
#> 2    13.5    13.1 13.1 13.5   -0.0217    13.1    13.5
#> 3    14.3    13.3 13.3 14.3   -0.6014    13.9    14.3
#> 4    13.3    13.2 13.2 13.3    0.2458    13.0    13.3
#> 5    12.0    11.9 11.9 12.0    0.1806    11.8    12.0
#> 6    13.0    12.8 12.8 13.0    0.2041    12.6    13.0
```
...
<img src="http://thebustalab.github.io/R_For_Chemists_3/images/hawaii_aquifers.jpeg" width="100%" style="display: block; margin: auto;" />
...
#>  [6] "aquifer_6"  "aquifer_7"  "aquifer_8"  "aquifer_9"  "aquifer_10"
```
...
<img src="http://thebustalab.github.io/R_For_Chemists_3/images/stats.png" width="100%" style="display: block; margin: auto;" />
...
#> 1 abundance aquifer_1 aquifer_6    12    12     -2.75  20.5 0.0121
```
...
#> 1 aquifer_code   9 100 10 7.72e-11     * 0.474
```
...
#> 1 aquifer_code aquif… aquif…          0  0.00357   -2.00      2.01  1     ns          
#> 2 aquifer_code aquif… aquif…          0  1.44      -0.668     3.55  0.456 ns          
#> 3 aquifer_code aquif… aquif…          0  0.375     -2.35      3.10  1     ns          
#> 4 aquifer_code aquif… aquif…          0 -1.15      -2.75      0.437 0.368 ns          
#> # … with 41 more rows
```
...
#> 1 abundance   110      57.7     9 0.0000000037 Kruskal-Wallis
```
...
#>   <chr>        <chr>   <chr>         <dbl>     <dbl>
#> 1 aquifer_1    Cl      abundance     0.900 0.159    
#> 2 aquifer_10   Cl      abundance     0.486 0.0000109
#> 3 aquifer_2    Cl      abundance     0.869 0.224    
...
#> 1 aquifer_1    abundance Cl     Na        12    12      99.5 0.119 0.119
#> 2 aquifer_10   abundance Cl     Na         7     7      14   0.198 0.198
#> 3 aquifer_2    abundance Cl     Na         6     6      36   0.005 0.005
#> 4 aquifer_3    abundance Cl     Na         3     3       3   0.658 0.658
#> # … with 6 more rows, and 1 more variable: p.adj.signif <chr>
```
...
<img src="http://thebustalab.github.io/R_For_Chemists_3/images/plot_quality.jpg" width="100%" style="display: block; margin: auto;" />
...
#>   lake                park  water_temp    pH element mg_per_L element_type
#>   <chr>               <chr>      <dbl> <dbl> <chr>      <dbl> <chr>       
#> 1 Devil_Mountain_Lake BELA        6.46  7.69 N          0.028 bound
...
#>   <chr>               <chr>      <dbl> <dbl> <chr>      <dbl> <chr>       
#> 1 Devil_Mountain_Lake BELA        6.46  7.69 N          0.028 bound       
#> 2 Devil_Mountain_Lake BELA        6.46  7.69 P          0     bound       
#> 3 Devil_Mountain_Lake BELA        6.46  7.69 Cl        10.4   free        
#> 4 Devil_Mountain_Lake BELA        6.46  7.69 S          0.62  free

# To look at just a single column, by name
alaska_lake_data$pH
#>   [1] 7.69 7.69 7.69 7.69 7.69 7.69 7.69 7.69 7.69 7.69 7.69 6.44 6.44 6.44 6.44
#>  [16] 6.44 6.44 6.44 6.44 6.44 6.44 6.44 7.45 7.45 7.45 7.45 7.45 7.45 7.45 7.45
#>  [31] 7.45 7.45 7.45 7.42 7.42 7.42 7.42 7.42 7.42 7.42 7.42 7.42 7.42 7.42 8.04
#>  [46] 8.04 8.04 8.04 8.04 8.04 8.04 8.04 8.04 8.04 8.04 7.82 7.82 7.82 7.82 7.82
#>  [61] 7.82 7.82 7.82 7.82 7.82 7.82 7.01 7.01 7.01 7.01 7.01 7.01 7.01 7.01 7.01
#>  [76] 7.01 7.01 7.03 7.03 7.03 7.03 7.03 7.03 7.03 7.03 7.03 7.03 7.03 6.95 6.95
#>  [91] 6.95 6.95 6.95 6.95 6.95 6.95 6.95 6.95 6.95 7.15 7.15 7.15 7.15 7.15 7.15
#> [106] 7.15 7.15 7.15 7.15 7.15 6.88 6.88 6.88 6.88 6.88 6.88 6.88 6.88 6.88 6.88
#> [121] 6.88 6.45 6.45 6.45 6.45 6.45 6.45 6.45 6.45 6.45 6.45 6.45 6.88 6.88 6.88
#> [136] 6.88 6.88 6.88 6.88 6.88 6.88 6.88 6.88 7.22 7.22 7.22 7.22 7.22 7.22 7.22
#> [151] 7.22 7.22 7.22 7.22 6.98 6.98 6.98 6.98 6.98 6.98 6.98 6.98 6.98 6.98 6.98
#> [166] 6.34 6.34 6.34 6.34 6.34 6.34 6.34 6.34 6.34 6.34 6.34 7.24 7.24 7.24 7.24
#> [181] 7.24 7.24 7.24 7.24 7.24 7.24 7.24 6.56 6.56 6.56 6.56 6.56 6.56 6.56 6.56
#> [196] 6.56 6.56 6.56 7.31 7.31 7.31 7.31 7.31 7.31 7.31 7.31 7.31 7.31 7.31 6.87
#> [211] 6.87 6.87 6.87 6.87 6.87 6.87 6.87 6.87 6.87 6.87
...
<img src="http://thebustalab.github.io/R_For_Chemists_3/images/project_overview.png" width="100%" style="display: block; margin: auto;" />

<img src="http://thebustalab.github.io/R_For_Chemists_3/images/scope.jpeg" width="100%" style="display: block; margin: auto;" />
...
<img src="http://thebustalab.github.io/R_For_Chemists_3/images/writing_order.png" width="100%" style="display: block; margin: auto;" />
...
periodic_table
#> # A tibble: 118 × 41
#>   atomic_number element_name atomic_symbol group_number period atomic_mass_roun…
#>           <dbl> <chr>        <chr>         <fct>         <dbl>             <dbl>
#> 1             1 hydrogen     H             1                 1              1.01
#> 2             2 helium       He            18                1              4.00
#> 3             3 lithium      Li            1                 2              6.97
#> 4             4 beryllium    Be            2                 2              9.01
#> # … with 114 more rows, and 35 more variables: melting_point_C <dbl>,
#> #   boiling_point_C <dbl>, state_at_RT <chr>, density_g_per_mL <dbl>,
#> #   electronegativity_pauling <dbl>, first_ionization_poten_eV <dbl>,
#> #   second_ionization_poten_eV <dbl>, third_ionization_poten_eV <dbl>,
#> #   electron_affinity_eV <dbl>, atomic_radius_ang <dbl>,
#> #   ionic_radius_ang <dbl>, covalent_radius_ang <dbl>,
#> #   atomic_volume_cm3_per_mol <dbl>, crystal_structure <chr>, …
```
