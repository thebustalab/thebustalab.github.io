...
Excellent, now we see how to run parametric and non-parametric pairwise comparisons.
...
Minimize revision with strategic order of composition.

Compare to class schedule
...
* Objective of this section: Walk your reader through your results, making interpretations as you go.
...
* Paragraph 3: Objectives of this study
  ...
  + For this project, briefly describe where you got the data, how you cleaned it up, if you merged multiple datasets, etc.
...
* Objective of the abstract: prove a short summary of the entire study.
* Objective of the title: Capture attention and highlight the research question.
