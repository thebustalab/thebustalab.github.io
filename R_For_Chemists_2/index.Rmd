...
* For the introduction, try this outline:
  
  1. **Paragraph 1: Introduce the topic**
    + (1 sentence) Introduce a topic, ideally, an application of the research you will describe (grab attention of reader with an important fact or relationship).
    + (1 sentence) State why the topic is important.
    + (1 sentence) Describe what is known about the topic (at least, as pertains to the work at hand).
    + (1 sentence) Identify a gap in knowledge: "despite research in this area, here is what we don't know about the topic."
    + (1 sentence) List the negative things that will happen if we don't fill this gap in knowledge.
    
  2. **Paragraph 2: Provide background information**
    + (3-5 sentences) Describe, in moderate detail, the background information (concepts, literature) relevant to the study.
    + (1 sentence) End by saying how the details you just described relate to the application/topic described in the first paragraph.

  3. **Paragraph 3: Objectives of this study**
    + (1 sentence) State the objective of this study.
    + (2-3 sentences) Briefly describe what was done and the techniques or instruments used.
    + (1-2 sentences) For this project, briefly describe where you got the data, how you cleaned it up, if you merged multiple datasets, etc.
...
* For the conclusion: summarize over-arching conclusions from each section of the paper (omit the details described in results or discussion)
