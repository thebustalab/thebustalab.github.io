...
2. You may find the `colnames()` function and square bracket-subsetting useful for this assignment. It will list all or a subset of the column names in a dataset for you. For example:
