...
knitr:::include_graphics('http://thebustalab.github.io/integrated_bioanalytics/images/phylochemistry_logo.jpg', dpi = NA)
```
...
knitr:::include_graphics('http://thebustalab.github.io/integrated_bioanalytics/images/overview.png', dpi = NA)
```
 -->
<!-- end -->
...
```{r out.width = "50%", fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), results="markup", fig.cap = "In chromatography we pass a mobile phase over a stationary phase. When we inject a sample into the mobile phase, the sample’s components both move with the mobile phase and partition into the stationary phase. The solute that spends the most time in the stationary phase takes the longest time to move through the system."}
knitr:::include_graphics('http://thebustalab.github.io/integrated_bioanalytics/images/mobile_stat_phase.png', dpi = NA)
```
...
```{r, echo = FALSE}
knitr::include_app("https://dthdpu.shinyapps.io/IntroChromatography/", height = "1200px")
```
<!-- end -->
...
```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), results="markup"}
knitr:::include_graphics('http://thebustalab.github.io/integrated_bioanalytics/images/rstudio_components.png', dpi = NA)
```
...
```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), results="markup"}
knitr:::include_graphics('http://thebustalab.github.io/integrated_bioanalytics/images/markdown_1.png', dpi = NA)
```
...
```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), results="markup"}
knitr:::include_graphics('http://thebustalab.github.io/integrated_bioanalytics/images/pipe.jpg', dpi = NA)
```
...
```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), results="markup"}
knitr:::include_graphics('http://thebustalab.github.io/integrated_bioanalytics/images/runMatrixAnalysis1.png', dpi = NA)
```
...
```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), results="markup"}
knitr:::include_graphics('http://thebustalab.github.io/integrated_bioanalytics/images/kmeans.png', dpi = NA)
```
...
```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), results="markup"}
knitr:::include_graphics('http://thebustalab.github.io/integrated_bioanalytics/images/Ex6Challenge.png', dpi = NA)
```
...
```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), results="markup"}
knitr:::include_graphics('http://thebustalab.github.io/integrated_bioanalytics/images/hawaii_aquifers.jpeg', dpi = NA)
```
...
```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), results="markup"}
knitr:::include_graphics('http://thebustalab.github.io/integrated_bioanalytics/images/stats.png', dpi = NA)
```
...
```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), results="markup"}
knitr:::include_graphics('http://thebustalab.github.io/integrated_bioanalytics/images/plot_quality.jpg', dpi = NA)
```
...
```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), results="markup"}
knitr:::include_graphics('http://thebustalab.github.io/integrated_bioanalytics/images/project_overview.png', dpi = NA)
```

```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), results="markup"}
knitr:::include_graphics('http://thebustalab.github.io/integrated_bioanalytics/images/scope.jpeg', dpi = NA)
```
...
```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), results="markup"}
knitr:::include_graphics('http://thebustalab.github.io/integrated_bioanalytics/images/writing_order.png', dpi = NA)
```
