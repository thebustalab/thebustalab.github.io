...
3. Conduct a PCA analysis of the `wood_smoke` data set. Make a figure with three subpanels: a plot of where each species is located in the first two principal components (a "pca" plot), a plot with ordination information, and a scree plot. In your figure caption, answer: How much of the overall variance in the data set is contained within the first two dimensions?
