...
```{r child="chapters/7_networks.Rmd"}
```

```{r child="chapters/8_hierarchical_clustering.Rmd"}
```

```{r child="chapters/9_dimensional_reduction.Rmd"}
```

```{r child="chapters/10_flat_clustering.Rmd"}
```

```{r child="chapters/11_comparing_means.Rmd"}
```
...
```{r child="chapters/12_numerical_models.Rmd"}
```

```{r child="chapters/13_language_models.Rmd"}
```

```{r child="chapters/14_protein_language_models.Rmd"}
```
...
```{r child="chapters/16_homology.Rmd"}
```

```{r child="chapters/17_alignments.Rmd"}
```

```{r child="chapters/18_phylogenies.Rmd"}
```

```{r child="chapters/19_phylogenetic_analysis.Rmd"}
```
...
```{r child="chapters/z_specialized_plots.Rmd"}
```
