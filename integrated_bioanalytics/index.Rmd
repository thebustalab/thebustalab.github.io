...
Time Series Analysis of Research Trends: Modify the search terms to retrieve publications over a period of several years. Embed the titles and visualize the changes in clustering over time using PCA. Discuss how research trends might evolve and reflect broader changes in the scientific community or societal challenges.
...
hops_embedded_pca$color <- rgb(
  scales::rescale(hops_embedded_pca$Dim.1, to = c(0, 1)),
  0,
  scales::rescale(hops_embedded_pca$Dim.2, to = c(0, 1))
)
