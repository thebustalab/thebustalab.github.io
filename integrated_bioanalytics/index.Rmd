...
There are several approaches to plotting trees. A simple one is using the base `plot` function, though this can get messy when there are lots of tip labels:
...
Here's another approach to plotting trees - using ggplots `fortify`. Let's try it:
