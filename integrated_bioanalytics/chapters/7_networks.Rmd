...
```{r fig.align='center', echo=FALSE, include=identical(knitr:::pandoc_to(), 'html'), results="markup", fig.cap='Overview of networks. The schematic shows a set of nodes (points) joined by edges (lines). Nodes represent entities and edges represent a relationship between them; properties of the entities can be encoded on the nodes and properties of the relationship can be encoded on the edges.'}
