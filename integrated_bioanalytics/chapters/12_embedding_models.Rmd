...
Below, we generate sentence-level GloVe embeddings for the PubMed titles retrieved in this chapter. This uses the same PubMed results as the analysis below, but switches the embedding method to GloVe by providing a local GloVe file path.

```{r, cache = TRUE}
search_results_glove <- embedText(
  search_results,
  column_name = "title",
  path_to_glove_file = "/Users/bust0037/Desktop/glove.6B.50d.txt"
)
search_results_glove[1:3,1:10]
```
