...
"What about the environmental impact?" It is the most common question I get after talking about AI with students and colleagues — and it is a fair one. AI runs on data centres that consume electricity and water, and the infrastructure is growing fast.

This post is a data-driven attempt to answer that question. The answer turns out to be less straightforward than the intuitions most people bring to it.

Two things need to be addressed separately, because they tell very different stories. The first is the environmental cost of *your* AI use — the queries you run, the summaries you request, the code you generate. The second is the aggregate cost of AI at the level of global infrastructure — the data centres, the chip manufacturing, the energy demand. I will work through each in turn, and then explain why the usual framing leads us astray.
...
A single text query to a model like ChatGPT, Claude, or Gemini consumes roughly 0.3 watt-hours of energy and produces about 0.03 grams of CO2 — less energy than running a microwave for two seconds. A hundred queries, a heavy day of AI-assisted research, produces about 3 grams of CO2, comparable to driving a car roughly 10 metres. Even 500 queries per day — an extraordinary amount of AI interaction — would account for about 1.5% of an average US household's daily electricity use.
...
For a researcher using AI for literature review, coding assistance, or data analysis, the individual environmental footprint of that use is, by any honest accounting, environmentally negligible.
...
Here is where the picture becomes more interesting than a simple "it's fine, don't worry." A 2024 study published in *Scientific Reports* compared the carbon emissions of writing and illustrating tasks performed by AI versus by humans. The result: AI-generated output produced substantially lower emissions than the human equivalent — in some cases, by a factor of 40 to 150. The reason is that the human process carries the full energy cost of a person working over hours or days — commuting, climate control, equipment — while the AI completes the same task in seconds using a fraction of the energy.
...
Data centre carbon emissions are currently estimated at about 180 million tonnes of CO2 per year — roughly 1.2% of global energy-sector emissions. For context: global aviation produces about 880 million tonnes per year, roughly 2% of the global total. The widely repeated claim that AI has already surpassed aviation is not supported by the most recent IEA data. But the trajectory matters: data centre emissions are growing at 12–17% per year, while aviation emissions are relatively stable.
...
Water is another dimension. Data centres require roughly 2 litres of water per kilowatt-hour for cooling. Globally, data centres used about 560 billion litres in 2024, projected to rise to 1,200 billion litres by 2030, and many data centres are sited in regions already under water stress.

The aggregate picture, then, is a real and growing environmental cost — a fast-growing one, and one being locked in through infrastructure decisions being made right now.

## Why the usual framing misleads

Most people think about this through the lens of personal environmental responsibility — the same lens we use for driving, flying, or eating meat. Use less, emit less. If AI is bad for the environment, the responsible thing is to use less of it.

This framing is intuitive, and for many environmental problems it works. But for AI, it is misleading in a way that matters.

If you bike to work instead of driving, you have directly reduced your emissions. The relationship between behaviour and outcome is straightforward: less driving, less carbon. With AI, the relationship is fundamentally different. Your individual query costs a fraction of a gram of CO2 — and as we saw above, using AI for a writing or analysis task can actually produce *less* carbon than doing the task yourself. More importantly, reducing your personal AI use does not reduce the infrastructure. The data centres are built, the chips manufactured, the cooling systems running whether you submit a query or not. The aggregate problem is driven by AI embedded in industrial processes, powering automated systems that run millions of operations per hour. It is an infrastructure problem, not a behaviour problem.

This is what makes AI structurally unlike personal vehicle emissions. Your choice to drive less is tiny but directionally correct — it maps, however faintly, onto the problem. Your choice to query less does not. In many cases, thoughtful AI use is the lower-emission option, and abstaining accomplishes nothing beyond denying yourself a useful tool.
...
The aggregate problem is real. But the right response is not guilt about your personal use. It is understanding where the real leverage points are.
...
**Be intentional, not abstinent.** Use AI when it genuinely helps your work. Do not use it frivolously — not because a frivolous query destroys the planet, but because intentional use is good practice for its own sake, and it happens to align with not generating pointless compute load.

**Understand the real leverage points.** The systemic environmental cost of AI is driven by data centre energy sourcing, cooling technology, geographic siting decisions, and the pace of grid decarbonisation. These are corporate governance and policy questions. If the environmental cost of AI genuinely concerns you, the most effective response is not behavioural (using AI less) but structural: supporting policies that require transparency in data centre energy and water reporting, advocating for renewable energy procurement standards, and understanding how grid infrastructure decisions are made.
...
The environmental cost of AI is real, growing, and worth taking seriously. But taking it seriously means understanding it accurately — through the lens of systems and infrastructure, not personal guilt.
