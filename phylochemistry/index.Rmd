...
If the library load correctly - then you are set to go! If not, try updating your R / RStudio installations, the reinstalling the `tidyverse`.

## Importing data

Let's import some data and get down to business! First, remember that RSudio operates as a session. 