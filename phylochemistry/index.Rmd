...
2. `phylochemistry` requires some other R packages to run, but it will help you install these packages if you haven't already. Load `phylochemistry` directly into your R session using the following:
```{r, message = FALSE}
