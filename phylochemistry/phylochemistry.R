...
###### Libraries
    ...
    ## Set up better warning messages for some functions
        ...
        shapiroTest <- function(data, var) {
            # Capture the variable using tidy evaluation
            var <- rlang::enquo(var)
            
            # Rename the specified column to "values"
            data <- data %>% dplyr::rename(values = !!var)
            
            # Check if any group has fewer than 3 observations
            ...
            # if yes, add a small amount of random noise to each point
            data <- data %>% dplyr::group_modify(~ {
                                        ...
                                        ## Add peaks, if any
                                            ...
                                            if (dim(peak_table)[1] > 0) {
                                                ...
                                                ## Add peaks
                                                    ...
                                                    for (peak in 1:dim(peak_table)[1]) { # peak = 1
                                                        # print(peak)
                        ...
                        sidebarLayout(
                            ...
                            sidebarPanel(
                                ...
                                tags$ul(
                                    ...
                                    tags$li("F, D, V, C => Move/Zoom X-axis"),
                                    tags$li("Shift + 1 => Extract MS from brush"),
                                    tags$li("Shift + 3 => Subtract MS from brush"),
                                    tags$li("Shift + 4 => Library search"),
                                    tags$li("Shift + 5 => Save MS")
                                ),
        ...
        #### readPDF
            ...
            readPDF <- function(path_to_pdf) {
                ...
                # set the path to the PDF file to be read
                    txt <- pdftools::pdf_text(path_to_pdf)
    ...
    ##### Mathematics, Statistical Testing, Modeling, Signal Processing
        ...
        #### anovaTestMean
            ...
            anovaMean <- function(object, n, ybar, s, ..., ylabel="ylabel") {
                ...
                result <- list(
                    Df=Df, "Sum of Sq"=Sum.of.Sq, "Mean Sq"=Mean.Sq,
